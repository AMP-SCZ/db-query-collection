...
SELECT 
  ...
  CASE
   ...
   WHEN subject.sankey_status = 'NO_MRI_DATA' AND reupload.reupload_issue_resolved = FALSE AND investigate.investigate_issue_resolved = FALSE THEN 'Marked as not expecting data, but DPACC has pending reupload and investigation issues for this subject that need to be addressed in the baseline or followup'
   WHEN subject.sankey_status = 'NO_MRI_DATA' AND investigate.investigate_issue_resolved = FALSE THEN 'Marked as not expecting data, but DPACC has pending investigation issues for this subject that need to be addressed in the baseline or followup'
   WHEN subject.sankey_status = 'NO_MRI_DATA' AND reupload.reupload_issue_resolved = FALSE THEN 'Marked as not expecting data, but DPACC has pending reupload issues for this subject that need to be addressed in the baseline or followup'
   ...
   WHEN subject.sankey_status = 'MARKED_MISSING' AND reupload.reupload_issue_resolved = FALSE AND investigate.investigate_issue_resolved = FALSE THEN 'Marked missing but DPACC has pending reupload AND/OR investigation issues for this subject pending that need to be addressed in the baseline or followup'
   WHEN subject.sankey_status = 'MARKED_MISSING' AND investigate.investigate_issue_resolved = FALSE THEN 'Marked missing but DPACC has pending investigation issues for this subject that need to be addressed in the baseline or followup'
   WHEN subject.sankey_status = 'MARKED_MISSING' AND reupload.reupload_issue_resolved = FALSE THEN 'Marked missing but DPACC has pending reupload issues for this subject that need to be addressed in the baseline or followup'
