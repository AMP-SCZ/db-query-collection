...
SELECT 
  ...
  CASE
   ...
   WHEN subject.sankey_status = 'MRI_DATA_FOUND' AND alt_investigate.investigate_issue_resolved = FALSE THEN 'DPACC has MRI data with pending investigation issues'
